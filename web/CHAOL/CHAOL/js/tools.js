...
;(function($){
	$.fn.calendar.dates['es'] = {
		days: ["Domingo", "Lunes", "Martes", "MiÈrcoles", "Jueves", "Viernes", "S·bado"],
		daysShort: ["Dom", "Lun", "Mar", "MiÈ", "Jue", "Vie", "S·b"],
...
//                    else {
//                        content += '<div class="event-tooltip-content">'
//                            + '<div class="event-name text-center">' + (e.events.length - 3).toString() + ' fletes m√°s</div>';
//                        break;
//                    }
//                }
